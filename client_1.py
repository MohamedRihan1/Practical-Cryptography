...
def receive():
    ...
    while True:
        try:
            ...
            msg = msg.split("*")
            hash_msg = msg[2]
            rsa_dec = PKCS1_OAEP.new(private_key_1)
...
def send(event=None):  # event is passed by binders.
    ...
    rsa_enc = PKCS1_OAEP.new(public_key_2)
...
public_key_1 = private_key_1.publickey().exportKey()
msg = public_key_1.decode("utf8")
CLIENT.send(bytes(msg, "utf8"))
m = CLIENT.recv(BUFFER_SIZE).decode("utf8")
public_key_2 = RSA.importKey(m)
